...
sp = spotipy.Spotify(auth_manager=SpotifyClientCredentials(
    client_id='d0db526ef8044d27901a6d09fc77ab58',  # Replace with your Client ID
    client_secret='7a5ae4e7f35f402da4621e03ff3899df'  # Replace with your Client Secret
))
...
df.to_csv(r"spotify_track_new.csv", index=False)
...
plt.bar(features, values, color='darkblue', edgecolor='black')
